...
export const SEGMENT_ITEM = `inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-md ${CONTROL_H.sm} px-3 font-medium text-sm outline-none transition-all active:scale-[0.97] disabled:pointer-events-none disabled:opacity-50 ${FOCUS_RING}`;
